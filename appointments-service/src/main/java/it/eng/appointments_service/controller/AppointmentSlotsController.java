...
public class AppointmentSlotsController {
    ...
    @GetMapping("/{physioId}")
    public ResponseEntity<List<AppointmentSlotDTO>> getAvailableSlotsByPhysio(@PathVariable @Positive Long physioId,
    ...
    public ResponseEntity<List<AppointmentSlotDTO>> getAvailableSlotsForAdminByPhysio(@PathVariable @Positive Long physioId,
                                                                                       @RequestParam @NotNull @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date) {
    ...
    public SlotAvailabilityResponse checkSlotAvailability(@PathVariable @Positive Long slotId) {
    ...
    public void reserveSlot(@PathVariable @Positive Long slotId) {
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void releaseSlot(@PathVariable @Positive Long slotId) {
        appointmentSlotService.releaseSlot(slotId);

    }

    @GetMapping("/findSlot/{slotId}")
    public AppointmentSlotDTO getSlotBySlotId(@PathVariable @Positive Long slotId) {
